...
let CFG = {};
try { CFG = require("../loi/don/order_config"); } catch (_) {}
const convTags = (() => { try { return require("../loi/pancake/conversation_tags"); } catch (_) { return null; } })();

// Hội thoại mặc định = c_id trong link bạn gửi
const CONV_ID = (process.argv[2] || "1468690110033030_6905067382943473").trim();

// Thẻ GIỮ (AI đứng ngoài) theo bot_worker_api_v3.js: HOLD_TAG_IDS = [183,184,185,166,177]
// 184 vào danh sách 25/08/2026 theo chốt của shop. Thiếu nó thì công cụ báo "không có thẻ
// giữ" trong khi bot đang đứng ngoài -> đọc log xong vẫn không hiểu vì sao bot im.
const HOLD_IDS = [183, 184, 185, 166, 177];
