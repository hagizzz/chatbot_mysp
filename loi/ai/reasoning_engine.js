...
const danhTinh = require("./danh_tinh_bot");
...
`;
  ...
  const kq = parseReplyAction(raw);
  // KHAI NGUỒN: câu này do KỊCH BẢN (Doc + tab AI AGENT) dạy ra. Code phía sau có
  // quyền đè lại câu khác — lúc đó turn_log tự loại lời khai này, không đếm nhầm.
  try { turnLog.nguonCau("ai_tu_do", kq.reply, "reasoning_engine.js"); } catch (_) {}
  return kq;
}
