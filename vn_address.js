...
try {
  const raw = JSON.parse(fs.readFileSync(path.join(__dirname, "vn_admin_2025.json"), "utf8"));
...
try {
  const wraw = JSON.parse(fs.readFileSync(path.join(__dirname, "vn_wards_2025.json"), "utf8"));
